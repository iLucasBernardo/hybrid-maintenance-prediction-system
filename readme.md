...
```
              ...
              ┌────────────────┴────────────────┐
              ▼                                  ▼
        Cluster A (stable)                Cluster B (degrading)
              │                                  │
     ┌────────┴────────┐               ┌────────┴────────┐
     ▼                 ▼                ▼                 ▼
   Trend            Residual          Trend            Residual
     │                 │                │                 │
1st-order OLS         MLP        2nd-order OLS            MLP
     │                 │                │                 │
     └───────┬─────────┘                └───────┬─────────┘
             ▼                                   ▼
          Recovery                            Recovery
...
![Critical Distance Diagram](./assets/critical_distance_diagram.png)
